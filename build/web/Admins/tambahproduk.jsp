                                ...
                                <form class="form-horizontal style-form" method="get">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <textarea class="form-control" name="message" id="contact-message" placeholder="Deskripsi Produk" rows="5" data-rule="required" data-msg="Please write something for us"></textarea>
